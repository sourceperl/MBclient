...
called a close/open cycle is initiate.
...
Example: C<print $m-E<gt>last_error();>
...
Example: C<print $m-E<gt>last_except();>
...
- The file "test.pl" is provide as a basic script. You can use it like a 
skeleton for begin a modbus script.
